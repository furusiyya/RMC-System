...
import controller_MenuSection.ModifyGUI_Handler;
...
//		
		ModifyGUI_Handler handler = new ModifyGUI_Handler(this); 
...
//		frame.getContentPane().add(panel);
		...
		table.setFont(new Font("Dialog", Font.PLAIN, 14));
				...
				saveBtn.setIcon(new ImageIcon(ModifyMenu.class.getResource("/icons/apply.png")));
				...
				deleteBtn.setIcon(new ImageIcon(ModifyMenu.class.getResource("/org/jdesktop/swingx/plaf/basic/resources/error16.png")));
